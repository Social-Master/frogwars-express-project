...
\begin{itemize}
  \item \textbf{Moving Straight:} For an object moving in a straight ahead \cite[p.~169]{nolting_grundkurs_2006}, its kinetic energy is calculated using this formula:
  \begin{equation}
