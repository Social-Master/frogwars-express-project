...
\begin{itemize}
    ...
    \item \textbf{Environmental Physics:} With dynamic acceleration and momentum mechanics now established, future iterations could incorporate track elevation and gradients, adding another layer of realism to how trains consume power on inclines or recover energy on declines.
...
Overall, we provide a robust proof of concept that ASP can effectively model and optimize physical constraints in railway logistics, laying the groundwork for future research into multi-objective routing.